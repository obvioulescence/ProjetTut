...
//definition.h
#define UBRRVAL1 8 // XBee baud rate 115200
...
#define dT		0.01	// période d'intégration du calcul d'angle de la tête
#define wGyro	5		// coefficient de confiance accordé au gyro par rapport à acc
#define wMoye	2		// coefficient d'adoussicement accordé à la valeur intégrée actuelle

#define ACC_MAX 65535
